...
let productData = ref({name: "",description: "",category: "",originalPrice: 0,pictureUrl: "",endDate: "",});
...
/**
 * @param {ProductObject} data
 * @param property -  {string} id
 * @param property -  {string} name
 * @param property -  {string} description
 * @param property -  {string} category
 * @param property -  {number} originalPrice
 * @param property -  {string} pictureUrl
 * @param property -  {Date} endDate
 */
...
/**
 * 
 * @param {string} date - String to transform into a Date object.
 * @returns Date, A date object with a Day, a Month and a Year.   
 */
